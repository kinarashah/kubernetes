...
func NewMainKubelet(kubeCfg *kubeletconfiginternal.KubeletConfiguration,
	...
	klog.InfoS("rancher: newcadvisor stats provider?", kubeDeps.useLegacyCadvisorStats)
	if kubeDeps.useLegacyCadvisorStats {
		...
		klog.InfoS("rancher: pod and container stats from cri?", utilfeature.DefaultFeatureGate.Enabled(features.PodAndContainerStatsFromCRI))
